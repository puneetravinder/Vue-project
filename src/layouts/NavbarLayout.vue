    ...
    <Navbar :theme="props.theme">
      ...
      <template #links>
        <div class="centered-links" :class="[activeSubnav === 'search' && 'is-hidden']">
          ...
          <a :class="[activeSubnav === 'elements' && 'is-active']" class="centered-link centered-link-toggle" tabindex="0"
            @keydown.space.prevent="toggleSubnav('elements')" @click="toggleSubnav('elements')">
            <i aria-hidden="true" class="iconify" data-icon="feather:box"></i>
            <span>Elements</span>
          </a>
        ...
        <div class="centered-search" :class="[activeSubnav !== 'search' && 'is-hidden']">
          <div class="field">
            <div class="control has-icon">
              <input v-model="filter" type="text" class="input is-rounded search-input" placeholder="Search records..." />
              <div class="form-icon">
                <i aria-hidden="true" class="iconify" data-icon="feather:search"></i>
              </div>
      ...
      <template #subnav>
        <div :class="[
          ...
          <OrdersSub :class="[activeSubnav === 'components' && 'is-active']" />
        </div>
      </template>
    </Navbar>
