...
<template>
  <VDropdown ref="dropdownElement" class="has-mega-dropdown" modern spaced>
    <template #button="{ toggle }">
      <div class="dropdown-trigger is-trigger" aria-haspopup="true" aria-controls="dropdown-menu">
        <VButton aria-haspopup="true" aria-controls="dropdown-menu" icon-caret="feather:chevron-down" rounded
          @click="toggle">
          Elements
        </VButton>
      </div>
    ...
    <template #content>
      <div class="category-selector" :class="[selectedCategory !== '' && 'is-hidden']">
        ...
        <div class="category-selector-inner">
          <!-- Interaction Item -->
          <div class="category-item" tabindex="0" @keydown.space.prevent="selectedCategory = 'interaction'"
            @click="selectedCategory = 'interaction'">
            <i aria-hidden="true" class="lnil lnil-pointer-top"></i>
            <span>Interaction</span>
          </div>
          <!-- Advanced Item -->
          <div class="category-item" tabindex="0" @keydown.space.prevent="selectedCategory = 'advanced'"
            @click="selectedCategory = 'advanced'">
            <i aria-hidden="true" class="lnil lnil-Website"></i>
            <span>Advanced</span>
          </div>
          <!-- Addons Item -->
          <div class="category-item" tabindex="0" @keydown.space.prevent="selectedCategory = 'addons'"
            @click="selectedCategory = 'addons'">
            <i aria-hidden="true" class="lnil lnil-code"></i>
            <span>Addons</span>
          </div>

          <img class="placeholder-image light-image" src="/@src/assets/illustrations/components/buttons.svg" alt="" />
          <img class="placeholder-image dark-image" src="/@src/assets/illustrations/components/buttons-dark.svg" alt="" />
        </div>
      </div>
      ...
      <div class="content-wrap" :class="[selectedCategory === '' && 'is-hidden']">
        ...
        <!--Interaction-->
        <div :class="[selectedCategory === 'interaction' && 'is-active']" class="columns is-gapless mega-menus">
          <!--Interaction/General-->
          <div class="column is-6">
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                ...
                <RouterLink to="/elements/icons/line-icons-light" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-minus"></i>
                  </div>
                  <div class="meta">
                ...
                <RouterLink to="/elements/icons/line-icons-regular" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-minus"></i>
                  </div>
                  <div class="meta">
                ...
                <RouterLink to="/elements/icons/font-awesome" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-minus"></i>
                  </div>
                  <div class="meta">
          ...
          <div class="column is-6">
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                ...
                <RouterLink to="/elements/placeload/avatar" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-reload"></i>
                  </div>
                  <div class="meta">
        ...
        <!--Advanced-->
        <div :class="[selectedCategory === 'advanced' && 'is-active']" class="columns is-gapless mega-menus">
          <!--Advanced/Forms-->
          <div class="column is-6">
            <div class="dropdown-item-group">
              <h4 class="column-heading is-info">
          ...
          <div class="column is-6">
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                <RouterLink to="/elements/animated-checkbox" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-round-box-check"></i>
                  </div>
                  <div class="meta">
        ...
        <!--Addons-->
        <div :class="[selectedCategory === 'addons' && 'is-active']" class="columns is-gapless mega-menus">
          <!--Addons/Addons-->
          <div class="column is-12">
            <div class="dropdown-item-group">
              ...
              <div class="column-content" data-simplebar>
                ...
                <RouterLink to="/elements/addons/imask-input" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-code"></i>
                  </div>
                  <div class="meta">
                ...
                <RouterLink to="/elements/addons/vueform-multiselect" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-code"></i>
                  </div>
                  <div class="meta">
                ...
                <RouterLink to="/elements/addons/vueform-slider" class="dropdown-item is-media">
                  <div class="icon">
                    <i aria-hidden="true" class="lnil lnil-code"></i>
                  </div>
                  <div class="meta">
