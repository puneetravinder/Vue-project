      ...
      <div class="tabs is-centered is-4">
        <ul>
          <li :class="[activeTab === 'interaction' && 'is-active']">
            <a tabindex="0" @keydown.space.prevent="activeTab = 'interaction'"
              @click="activeTab = 'interaction'">Interaction</a>
          </li>
          <li :class="[activeTab === 'advanced' && 'is-active']">
            <a tabindex="0" @keydown.space.prevent="activeTab = 'advanced'" @click="activeTab = 'advanced'">Advanced</a>
          </li>
        </ul>
      </div>
    </div>
            ...
            <div class="columns">
              <div class="column is-3">
                <h4 class="column-heading">
                  <span>Forms</span>
                  <VTag label="v2.3" color="primary" size="tiny" class="ml-2" outlined curved />
                </h4>
                <ul>
                  <li>
