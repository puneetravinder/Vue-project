    ...
    <Sidebar :theme="props.theme">
      ...
      <template #bottom-links>
        ...
        <li class="right-panel-trigger is-hidden-tablet">
          <a data-content="Search" tabindex="0" @keydown.space.prevent="panels.setActive('search')"
            @click="panels.setActive('search')">
            <i aria-hidden="true" class="iconify sidebar-svg" data-icon="feather-search" />
          </a>
          <a class="is-hidden is-inactive" tabindex="0" @keydown.space.prevent="panels.close()" @click="panels.close()">
