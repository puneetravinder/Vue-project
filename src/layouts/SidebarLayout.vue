  ...
  <div class="sidebar-layout">
    ...
    <MobileSidebar :is-open="isMobileSidebarOpen" @toggle="isMobileSidebarOpen = !isMobileSidebarOpen">
      <template #links>
        ...
        <li>
          <a aria-label="Display orders content" :class="[activeMobileSubsidebar === 'orders' && 'is-active']"
            tabindex="0" @keydown.space.prevent="activeMobileSubsidebar = 'orders'"
            @click="activeMobileSubsidebar = 'orders'">
    ...
    <Sidebar :theme="props.theme" :is-open="isDesktopSidebarOpen">
      <template #links>
        ...
        <!-- Orders -->
        <li>
          <a :class="[activeMobileSubsidebar === 'orders' && 'is-active']" data-content="Orders" aria-label="View orders"
    ...
    <Transition name="slide-x">
      <KeepAlive>
        ...
        <LayoutsSubsidebar v-else-if="isDesktopSidebarOpen && activeMobileSubsidebar === 'layout'"
          @close="isDesktopSidebarOpen = false" />
        <OrdersSubsidebar v-else-if="isDesktopSidebarOpen && activeMobileSubsidebar === 'orders'"
          @close="isDesktopSidebarOpen = false" />
      </KeepAlive>
    </Transition>
