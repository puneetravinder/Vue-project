...
viewWrapper.setPageTitle('Table')
...
<template>
  <div class="page-content-inner">
    ...
    <div class="columns">
      <div ref="markdownContainer" :class="[toc.length > 0 ? 'is-9' : 'is-12']" class="column doc-column">
        <!--Table-->
        <TableBaseDocumentation />

        <VCard radius="smooth" class="demo-table mb-6">
          <table class="table is-hoverable is-fullwidth" aria-label="Vuero basic table example">
            <thead>
              <tr>
        ...
        <VCard radius="smooth" class="demo-table">
          <table class="table is-striped is-fullwidth" aria-label="Vuero striped table example">
            <thead>
              <tr>
                <th scope="col">First Name</th>
                <th scope="col">Last Name</th>
        ...
        <VCard radius="smooth" class="demo-table">
          <table class="table is-hoverable is-fullwidth" aria-label="Vuero media table example">
            <thead>
              <tr>
